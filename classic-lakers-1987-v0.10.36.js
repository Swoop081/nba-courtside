...
(()=>{
  ...
  const rows=[
    ['Magic Johnson','PG',[24,18,16,22,30,20,28],30],
    ['Byron Scott','SG',[21,20,18,16,21,16,27],23],
    ['James Worthy','SF',[23,27,11,22,19,25,25],26],
    ['A.C. Green','PF',[16,22,11,26,8,25,20],21],
    ['Kareem Abdul-Jabbar','C',[23,20,11,24,19,27,10],25]
  ];
  const slugs={
