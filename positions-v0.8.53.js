/* NBA Courtside v0.8.79 — positions + premium stats + baked art layout + normalized Card Art Editor sync + set backgrounds */
(()=>{
  ...
  load('set-backgrounds-v0.8.79.js',()=>load('positions-core-v0.8.63.js',()=>load('premium-stats-v0.8.68.js',()=>load('art-layout-v0.8.70.js',()=>load('art-editor-v0.8.64.js',()=>load('art-editor-match-v0.8.74.js',()=>load('art-authority-v0.8.78.js')))))));
})();
