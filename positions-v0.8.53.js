/* NBA Courtside v0.8.64 — positions + balanced teams + Card Art Editor authority */
(() => {
  ...
  const style=document.createElement('style');style.id='courtside-position-style-v0864';style.textContent=`.player-card .card-position{position:absolute;top:12px;right:13px;z-index:39;color:#fff;font-size:15px;line-height:1;font-weight:1000;letter-spacing:.045em;text-shadow:0 2px 5px rgba(0,0,0,.9),0 0 8px rgba(0,0,0,.7);pointer-events:none}.catalogue-grid .player-card .card-position{top:7px;right:8px;font-size:8px;letter-spacing:.03em}#final .final-team strong.final-score-three{font-size:54px!important;letter-spacing:-.075em!important}@media(max-width:430px){.player-card .card-position{top:10px;right:11px;font-size:13px}.catalogue-grid .player-card .card-position{top:6px;right:7px;font-size:7.5px}#final .final-card{padding:8px 8px 8px!important;gap:5px!important}#final .story-summary{gap:4px!important;margin-top:0!important}#final .story-row{padding:8px 10px!important;gap:9px!important}#final .story-row small{margin-top:3px!important}#final .final-winner{margin:0 0 2px!important}#final .final-team strong.final-score-three{font-size:47px!important;letter-spacing:-.075em!important}}`;document.head.appendChild(style);
...
window.addEventListener('load',()=>setTimeout(()=>{
  ...
  window.__courtsideFinalPolishInstalled=true;const beforeFinish=finishGame;
...
/* One authoritative art-position system. Legacy one-off Thunder framing has been removed. */
(()=>{const s=document.createElement('script');s.src='art-editor-v0.8.64.js?t='+(window.COURTSIDE_ASSET_TOKEN||Date.now());s.async=false;document.head.appendChild(s);})();
