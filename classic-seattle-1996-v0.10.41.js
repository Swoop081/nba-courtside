...
(()=>{
  ...
  const rows=[
    ['Gary Payton','PG',[20,18,19,16,26,16,29],29],
    ['Hersey Hawkins','SG',[19,12,21,15,19,16,28],23],
    ['Detlef Schrempf','SF',[20,16,19,21,22,10,19],24],
    ['Shawn Kemp','PF',[23,30,16,27,17,27,23],29],
    ['Ervin Johnson','C',[8,19,11,26,5,30,19],17]
  ];
  const slugs={
