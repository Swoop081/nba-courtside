/* NBA Starting5 v0.12.07 — authoritative red Western Conference scoreboard override + All-Star/Rising Stars special-game loaders + season-only dynamic ratings + authentic CPU simulation + Who's Hot/Who's Not + long-session performance fix + corrected matchup rail ordering/selection highlights + home Continue Season ordering. */
(()=>{
  ...
  load('data-s5-lineup-dom-reuse-v01207','lineup-dom-reuse-v0.12.07.js');
  load('data-s5-selected-card-highlight-v01207','selected-card-highlight-v0.12.07.js');
