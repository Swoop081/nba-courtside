...
# Stronger positional compression keeps the top end genuinely elite and prevents ordinary
# wings/bigs from automatically living in the 26-30 band. Small guards are heavily discounted
# unless there is clear evidence of real NBA dunk ability.
factor={'PG':0.55,'SG':0.75,'SF':0.82,'PF':0.85,'C':0.85}

# Curated scouting overrides. Elite/contest/reputation dunkers are deliberately rewarded;
# small non-dunkers are deliberately suppressed. Secondary athletic finishers sit mostly 21-27.
over={
...
# Exact 25 Classic cards, using the represented season and dunking reputation rather than
# era-adjusted box-score volume.
classic=[
...
result={'status':'SUBJECTIVE_AUDIT_ONLY_NOT_APPLIED_TO_GAMEPLAY','method':'existing dunk baseline + stronger positional compression + curated scouting overrides for reputation, dunk-contest pedigree, vertical explosiveness, size and practical dunk capability','count':175,'distribution':bands,'players':rows}
