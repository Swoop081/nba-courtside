...
const D=pre.NBA_COURTSIDE_DATA,S=pre.NBA_COURTSIDE_SCHEDULE,cert=JSON.parse(fs.readFileSync(path.join(root,'data/certification-v0.16.json'),'utf8'));
...
const perTeam=Object.fromEntries(Object.entries(totals).map(([k,v])=>[k,v/teamGames])),target=cert.bootstrap_2025_26_team_targets,comparison={};
