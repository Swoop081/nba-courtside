...
for(const f of ['data/data-v0.37.js','data/source-certification-v0.37.js','data/future-pick-ledger-v0.37.js','data/schedule-v0.37.js','data/schedule-template-v0.37.js','cba-v0.37.js','data/organizations-v0.37.js','data/g-league-v0.37.js','data/college-draft-v0.37.js'])vm.runInContext(fs.readFileSync(root+'/'+f,'utf8'),ctx,{filename:f});
vm.runInContext(fs.readFileSync(root+'/data/g-league-v0.37.js','utf8'),ctx,{filename:'data/g-league-v0.37.js'});vm.runInContext(fs.readFileSync(root+'/data/college-draft-v0.37.js','utf8'),ctx,{filename:'data/college-draft-v0.37.js'});
