...
for(const f of ['data/data-v0.32.js','data/source-certification-v0.32.js','data/future-pick-ledger-v0.32.js','data/schedule-v0.32.js','data/schedule-template-v0.32.js','cba-v0.32.js','data/organizations-v0.32.js'])vm.runInContext(fs.readFileSync(root+'/'+f,'utf8'),ctx,{filename:f});
