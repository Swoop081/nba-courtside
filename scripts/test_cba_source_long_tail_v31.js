...
for(const f of ['data/data-v0.31.js','data/source-certification-v0.31.js','data/future-pick-ledger-v0.31.js','data/schedule-v0.31.js','data/schedule-template-v0.31.js','cba-v0.31.js','data/organizations-v0.31.js'])vm.runInContext(fs.readFileSync(root+'/'+f,'utf8'),ctx,{filename:f});
