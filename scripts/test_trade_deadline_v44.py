...
app=(ROOT/'app-v0.44.js').read_text()
...
check('main menu v44 branding', 'V0.44 TRADE DEADLINE + TRANSACTION PRESENTATION' in index)
...
for js in ['app-v0.44.js','cba-v0.44.js','gameday-v0.44.js','exhibition-v0.44.js']:
