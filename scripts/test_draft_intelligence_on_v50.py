...
app=(ROOT/'app-v0.50.js').read_text(); index=(ROOT/'index.html').read_text(); gd=(ROOT/'gameday.html').read_text(); ex=(ROOT/'exhibition.html').read_text()
checks=[]
def ck(n,c): checks.append((n,bool(c)))
ck('index pins v049 app','app-v0.50.js' in index)
ck('gameday pins v049','gameday-v0.50.js' in gd)
ck('exhibition pins v049','exhibition-v0.50.js' in ex)
