...
ck('v45 branding', 'V0.49 ADVANCED SCOUTING + DRAFT INTELLIGENCE' in index)
ck('v45 app pin', 'app-v0.49.js' in index)
ck('v45 gameday pin', 'gameday-v0.49.js' in game)
ck('v45 exhibition pin', 'exhibition-v0.49.js' in ex)
ck('exhibition query v45', "exhibition.html?v=0.49" in index)
...
for f in ['app-v0.49.js','gameday-v0.49.js','exhibition-v0.49.js','cba-v0.44.js']:
