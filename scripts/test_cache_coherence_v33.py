...
raw=(ROOT/'data'/'data-v0.33.js').read_text().strip()
...
assert 'V0.33 ACTIVE FRONT OFFICES' in idx
assert "exhibition.html?v=0.33" in idx
print('PASS v0.33 cache coherence: versioned runtime assets + certified ratings smoke values')
