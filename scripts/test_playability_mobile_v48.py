...
gd=(ROOT/'gameday-v0.48.js').read_text()
ex=(ROOT/'exhibition-v0.48.js').read_text()
...
ck('index loads app-v0.48', 'app-v0.48.js' in index)
ck('gameday loads gameday-v0.48', 'gameday-v0.48.js' in ghtml)
ck('exhibition loads exhibition-v0.48', 'exhibition-v0.48.js' in ehtml)
...
# Syntax
for fname in ['app-v0.48.js','gameday-v0.48.js','exhibition-v0.48.js']:
