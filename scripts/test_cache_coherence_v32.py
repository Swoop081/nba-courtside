...
raw=(ROOT/'data'/'data-v0.32.js').read_text().strip()
...
assert 'V0.32 DAILY BROADCAST OVERHAUL' in idx
assert "exhibition.html?v=0.32" in idx
print('PASS v0.32 cache coherence: versioned runtime assets + certified ratings smoke values')
