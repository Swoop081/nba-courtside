...
for(const f of ['data/data-v0.34.js','data/source-certification-v0.34.js','data/future-pick-ledger-v0.34.js','data/schedule-v0.34.js','data/schedule-template-v0.34.js','cba-v0.34.js','data/organizations-v0.34.js'])vm.runInContext(fs.readFileSync(root+'/'+f,'utf8'),ctx,{filename:f});
