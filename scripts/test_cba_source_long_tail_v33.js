...
for(const f of ['data/data-v0.33.js','data/source-certification-v0.33.js','data/future-pick-ledger-v0.33.js','data/schedule-v0.33.js','data/schedule-template-v0.33.js','cba-v0.33.js','data/organizations-v0.33.js'])vm.runInContext(fs.readFileSync(root+'/'+f,'utf8'),ctx,{filename:f});
