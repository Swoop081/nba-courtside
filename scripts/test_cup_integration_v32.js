...
const dataJs=fs.readFileSync(root+'/data/data-v0.32.js','utf8');
const schedJs=fs.readFileSync(root+'/data/schedule-v0.32.js','utf8');
const templateJs=fs.readFileSync(root+'/data/schedule-template-v0.32.js','utf8');
let src=fs.readFileSync(root+'/app-v0.32.js','utf8');
...
ctx.window=ctx;vm.createContext(ctx);vm.runInContext(dataJs,ctx);vm.runInContext(fs.readFileSync(root+'/data/source-certification-v0.32.js','utf8'),ctx);vm.runInContext(fs.readFileSync(root+'/data/future-pick-ledger-v0.32.js','utf8'),ctx);vm.runInContext(schedJs,ctx);vm.runInContext(templateJs,ctx);vm.runInContext(fs.readFileSync(root+'/cba-v0.32.js','utf8'),ctx);vm.runInContext(fs.readFileSync(root+'/data/organizations-v0.32.js','utf8'),ctx);vm.runInContext(src,ctx);
