...
app=(ROOT/'app-v0.48.js').read_text()
...
ck('v45 branding', 'V0.48 PLAYABILITY + MOBILE PRESENTATION' in index)
ck('v45 app pin', 'app-v0.48.js' in index)
ck('v45 gameday pin', 'gameday-v0.48.js' in game)
ck('v45 exhibition pin', 'exhibition-v0.48.js' in ex)
ck('exhibition query v45', "exhibition.html?v=0.48" in index)
...
for f in ['app-v0.48.js','gameday-v0.48.js','exhibition-v0.48.js','cba-v0.44.js']:
