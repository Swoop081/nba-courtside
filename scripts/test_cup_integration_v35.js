...
const dataJs=fs.readFileSync(root+'/data/data-v0.35.js','utf8');
const schedJs=fs.readFileSync(root+'/data/schedule-v0.35.js','utf8');
const templateJs=fs.readFileSync(root+'/data/schedule-template-v0.35.js','utf8');
...
ctx.window=ctx;vm.createContext(ctx);vm.runInContext(dataJs,ctx);vm.runInContext(fs.readFileSync(root+'/data/source-certification-v0.35.js','utf8'),ctx);vm.runInContext(fs.readFileSync(root+'/data/future-pick-ledger-v0.35.js','utf8'),ctx);vm.runInContext(schedJs,ctx);vm.runInContext(templateJs,ctx);vm.runInContext(fs.readFileSync(root+'/cba-v0.35.js','utf8'),ctx);vm.runInContext(fs.readFileSync(root+'/data/organizations-v0.35.js','utf8'),ctx);vm.runInContext(fs.readFileSync(root+'/data/g-league-v0.35.js','utf8'),ctx);vm.runInContext(fs.readFileSync(root+'/data/college-draft-v0.35.js','utf8'),ctx);vm.runInContext(src,ctx);
