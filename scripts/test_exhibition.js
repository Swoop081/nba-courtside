...
const dataJs=fs.readFileSync('/mnt/data/NBA-Courtside-Exhibition-v0.6/data/data.js','utf8');
let src=fs.readFileSync('/mnt/data/NBA-Courtside-Exhibition-v0.6/exhibition.js','utf8');
