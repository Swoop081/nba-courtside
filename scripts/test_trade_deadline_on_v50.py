...
check('main menu v48 branding', 'V0.50 STAFF, COACHING + ORGANIZATIONAL IDENTITY' in index)
...
for js in ['app-v0.50.js','cba-v0.44.js','gameday-v0.50.js','exhibition-v0.50.js']:
