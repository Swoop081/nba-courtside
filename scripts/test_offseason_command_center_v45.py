...
app=(ROOT/'app-v0.45.js').read_text()
...
ck('v45 branding', 'V0.45 OFFSEASON COMMAND CENTER' in index)
ck('v45 app pin', 'app-v0.45.js' in index)
ck('v45 gameday pin', 'gameday-v0.45.js' in game)
ck('v45 exhibition pin', 'exhibition-v0.45.js' in ex)
ck('exhibition query v45', "exhibition.html?v=0.45" in index)
...
for f in ['app-v0.45.js','gameday-v0.45.js','exhibition-v0.45.js','cba-v0.44.js']:
