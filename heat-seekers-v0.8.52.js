/* NBA Starting5 v0.11.17 — final winner headline + working lower Menu + stable gameplay systems */
(()=>{
  ...
  document.write('<script src="season-hub-details-v0.11.16.js?t='+t+'"><\/script>');
