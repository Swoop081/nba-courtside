/* NBA Courtside v0.10.1 — Season Mode loading hotfix + logo-only team picker + current 30 + Classic Teams + canonical art + default player glow */
(()=>{
  ...
  document.write('<script src="season-mode-hotfix-v0.10.1.js?t='+t+'"><\/script>');
