/* NBA Courtside v0.9.13 — Foundation + PNG-only art pass + 20% smaller gameplay rail + unslashed zero numerals + Detroit position swap + first-card rail padding + centred rating */
(()=>{
