/* NBA Starting5 v0.11.19 — Season matchup records + standings streak + stable gameplay systems */
(()=>{
  ...
  document.write('<script src="season-hub-standings-v0.11.19.js?t='+t+'"><\/script>');
