/* NBA Starting5 v0.13.0-dev.4 — Season scoreboard/result adapter. No gameplay wrappers or polling. */
(()=>{
  if(window.__starting5SeasonCoreUiV01304)return;
  window.__starting5SeasonCoreUiV01304=true;
  ...
  function goSeasonHub(e){
    ...
    try{sessionStorage.removeItem(ACTIVE_KEY);sessionStorage.removeItem(PENDING_KEY)}catch{}window.STARTING5_SEASON_MODE?.renderHub?.();try{showScreen('seasonHub')}catch{}window.scrollTo({top:0,behavior:'instant'});
  }
