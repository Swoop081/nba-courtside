/* NBA Courtside v0.9.32 — per-player PNG edge glow toggle */
(()=>{
  ...
  const enabledFor=p=>!!read()[p?.artSlug];
  ...
  function installControl(){
    ...
    toggle.addEventListener('change',()=>{
      ...
      if(toggle.checked)store[p.artSlug]=true;else delete store[p.artSlug];
