/* NBA Starting5 v0.11.78 — Rising Stars uses the exact normal matchup scoreboard structure with conference branding. */
(()=>{
  ...
  style.textContent=`
    ...
    #game.s5-rising-stars-game .score-logo-wrap{height:76px!important;display:flex!important;align-items:center!important;justify-content:center!important;background:rgba(0,0,0,.10)!important}
    #game.s5-rising-stars-game .score-logo-wrap img{width:78px!important;height:72px!important;object-fit:contain!important;filter:drop-shadow(0 4px 9px rgba(0,0,0,.45))!important}
