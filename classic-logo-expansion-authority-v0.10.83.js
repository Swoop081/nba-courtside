/* NBA Starting5 v0.10.83 — logo authority for Orlando 1995, Bobcats 2007, Clippers 2014 */
(()=>{
  if(window.__starting5ClassicLogoExpansionAuthorityV01083)return;
  window.__starting5ClassicLogoExpansionAuthorityV01083=true;
  const LOGOS={
