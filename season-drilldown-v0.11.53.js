/* NBA Starting5 v0.11.56 — reliable season player card inspect + catalogue-style centered team overview. */
(()=>{
  ...
  const css=document.createElement('style');css.id='s5-season-drilldown-style';css.textContent=`
    ...
    @media(max-width:430px){.s5-inspect-stage{width:min(88vw,360px)}.s5-team-overview-grid{grid-template-columns:repeat(6,minmax(0,1fr));gap:6px}.s5-team-overview-hero{padding:20px 14px}.s5-team-overview-hero img{width:92px;height:92px}}
