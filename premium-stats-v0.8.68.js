/* NBA Courtside v0.8.73 — full-size premium stat rail */
(()=>{
  ...
  style.id='courtside-premium-stats-v0873';
  style.textContent=`
    .player-card .stats{left:4px!important;width:64px!important;top:7px!important;gap:0!important}
    ...
    .player-card .stat-label{font-size:7px!important;line-height:1!important;max-width:29px!important;font-weight:1000!important;letter-spacing:.035em!important;color:rgba(255,255,255,.94)!important;text-shadow:0 1px 3px rgba(0,0,0,.92)!important}
    ...
    .catalogue-grid .player-card .stats{left:3px!important;top:4px!important;bottom:35px!important;width:54px!important}
    ...
    .catalogue-grid .player-card .stat-label{font-size:5.6px!important;max-width:25px!important;letter-spacing:.025em!important}
  `;
