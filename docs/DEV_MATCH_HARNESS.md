> This document describes the private arbitrary-team test harness retained for development. It is not a player-facing NBA Courtside mode.

# Internal QA — Match Engine Harness
